...
import com.leafCat.common.music.vo.MusicVO;
...
public class LoginController {
    ...
    private ModelAndView moveLogin(@ModelAttribute MusicVO musicVO, HttpServletRequest request, HttpServletResponse response) throws Exception {
		HttpSession session = request.getSession();
		MusicVO sessionVO = (MusicVO) session.getAttribute("loginUser");
